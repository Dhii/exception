...
class InternalExceptionTest extends TestCase
{
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'Dhii\Exception\InternalException';
    ...
    public function testCanBeCreated()
    {
        ...
        $this->assertInstanceOf('Dhii\Exception\InternalExceptionInterface', $subject, 'Subject is not a valid Dhii throwable');
    }
